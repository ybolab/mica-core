...
///
/// **Lifted into `micad-settings`**, for the reason the length
...
/// with the first. `micad_settings::is_wpa_quotable` states the predicate --
...
/// file is micad's render of `wifi.client`, and a `wpa_cli save_config` that
