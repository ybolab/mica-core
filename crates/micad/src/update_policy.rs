...
//!
//! What that leaves here is the one thing micad needs and apid does not: a
...
impl PolicyStore {
    ...
    ///
    /// This is the *only* difference between micad's view and apid's: the
    /// library returns `Err` for a document that did not load, and micad needs
