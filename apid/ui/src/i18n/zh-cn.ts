...
export const zhCN: Translation = {
  ...
  system: {
    ...
    simulationScope: '自动更新策略、临时支持访问与恢复控件',
    ...
    recovery: {
      ...
      resetTitle: '恢复出厂设置', resetDescription: '清除设置、应用状态和用户数据，然后重新进入设置流程。', reset: '恢复出厂设置', confirmTitle: '重置此设备？', confirmDescription: '此模拟仅展示破坏性操作的确认流程，不会清除设备数据。', resetQueued: '模拟恢复出厂设置已排队。',
