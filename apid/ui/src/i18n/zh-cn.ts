...
export const zhCN: Translation = {
  ...
  network: {
    ...
    tabs: { interfaces: '接口', wifi: 'Wi-Fi', wireguard: 'WireGuard' }, interfaceCount: '{{count}} 个接口', actions: { addInterface: '添加接口' },
  ...
  system: {
    ...
    simulationScope: '设备信息、时间、自动更新策略、存储、诊断、支持与恢复控件',
    tabs: { general: '常规', information: '信息', time: '时间', update: '更新与恢复', storage: '存储', diagnostics: '诊断', recovery: '恢复' },
    information: { title: '设备信息', description: '硬件标识与正在运行的软件版本。', model: '型号', serial: '序列号', release: '系统版本', api: 'API 版本', daemon: '守护进程', health: '健康状态' },
    time: {
      title: '时间设置', description: '时区与可信网络时间源。', timezone: '时区', ntp: 'NTP 服务器', ntpHint: '按优先级使用逗号分隔。', saved: '模拟时间设置已保存。',
      statusTitle: '同步状态', statusDescription: '当前时钟与同步来源。', localTime: '本地时间', utcTime: 'UTC 时间', source: '来源', offset: '时钟偏移', synchronized: '系统时钟已同步。',
    },
    storage: { allocationTitle: 'DATA 空间分配', allocationDescription: '系统管理内容与用户内容占用的空间。', applications: '应用与容器', updates: '更新工作区', userData: '/srv 下的用户数据', available: '可用空间', used: '已使用 {{value}}%' },
    diagnostics: {
      bundleTitle: '支持包', bundleDescription: '收集已脱敏日志、健康报告和配置元数据。', collect: '收集支持包', download: '下载支持包', ready: '诊断支持包已可下载。',
      supportTitle: '临时支持访问', supportDescription: '授予有审计记录且限时的故障排查会话。', supportAccess: '启用支持访问', supportCopy: '60 分钟后自动失效。', expires: '支持访问将在 60 分钟后失效', disabled: '支持访问已停用',
    },
    recovery: {
