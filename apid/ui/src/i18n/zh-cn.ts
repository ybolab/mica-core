...
export const zhCN: Translation = {
  ...
  observedNetwork: {
    eyebrow: '连接',
    title: '观测网络',
    description: '运行中的网络栈报告的载波、地址、租约、路由、DNS 和无线状态。',
    separation: '此页面仅显示观测状态，不显示或更改期望的网络配置。',
    openDesired: '打开期望网络设置',
    loading: '正在读取观测网络状态…',
    unavailable: '观测证据不可用',
    interfaces: {
      title: '接口',
  ...
  systemInformation: {
    eyebrow: '设备',
    title: '系统信息',
    description: '通过一次 API 读取获取设备标识、软件版本、构建来源、启动槽位和运行时间。',
    loading: '正在读取系统信息…',
    unavailable: '不可用',
    identity: {
      title: '设备标识',
  ...
  diagnostics: {
    eyebrow: '支持',
    title: '诊断',
    description: '无需启用 SSH 即可生成、下载和删除有界且已脱敏的快照。',
    collection: {
      title: '收集快照',
    ...
    snapshots: {
      title: '已存储快照',
      description: '下载内容已经脱敏，并在经过认证的操作员导出前保留在本设备上。',
      loading: '正在读取已存储快照…',
      empty: '未存储诊断快照。',
      snapshot: '快照 {{id}}',
      download: '下载',
