...
make check           # lint, the UI build contract, the Rust gate (scripts/build/check.sh)
...
producers under `packaging/deb/`; `scripts/gate/dbus-policy-test.sh` proves the shipped
