...
///
/// `/var/lib/mos` is a bind mount whose source is `/mnt/data/state/mos`.
pub const DEFAULT_STATE_DIR: &str = "/var/lib/mos";
...
/// [`SECRET_FILE_MODE`].
///
/// Same shape as `mosd_settings::Store::save`: write a temp file beside the
...
mod tests {
    ...
    fn fresh_state_gets_identity_and_both_secrets() {
        ...
        assert_eq!(
            ...
            mosd_settings::ProvisioningState::Pending
        );
    }
