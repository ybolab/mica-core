...
use mosd_settings::{DocumentRefusal, Settings, SettingsError, Store, json_path_get};
...
mod tests {
    ...
    use super::{DocumentRefusal, Inner, MosdService, paths_overlap, run_apply_worker};
    use crate::confirmed_boot::ConfirmedBootStore;
